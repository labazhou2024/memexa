...
from src.core.atomic_io import atomic_write_json, safe_read_json
...
# source: src.chat.metadata_builder.HASH_LEN. The previous [:16] for
# chat_hash key violated AC-U10-15 + AC-U10-25 + RP-5 (128-bit preimage floor).
from src.chat.metadata_builder import HASH_LEN
...
def chat_hash(chat_name: str) -> str:
    ...
    single source via src.chat.metadata_builder.HASH_LEN constant.
    """
    if not chat_name:
        chat_name = ""
