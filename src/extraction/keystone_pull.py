...
def pull_all(
    ...
    # WeChat
    try:
        from src.extraction.wechat_read import poll_and_write as wechat_pw
    ...
    # Email
    try:
        from src.extraction.email_read import poll_and_write as email_pw
    ...
    # Schedule
    try:
        from src.extraction.schedule_poll import poll_and_write as schedule_pw
