...
`src.extraction.audio_pipeline` and `voice_resolver.resolve_session`, then
...
def _auto_classify_session_dir(session_dir: Path,
    ...
    try:
        from src.extraction.audio_session_classifier import classify_session
...
def build_session_batches(
    ...
    # Voice resolution
    from src.extraction.voice_resolver import (
