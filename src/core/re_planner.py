...
from src.core.task_unit_scheduler import _cycle_check, TaskUnit
...
def run_replan(task_id: str, failure_ctx: Dict[str, Any] = None,
    ...
    from src.core.failure_cluster_detector import (
...
def main(argv: Optional[List[str]] = None) -> int:
    """CLI: python -m src.core.re_planner <task_id> [--context path.json]"""
    import argparse
