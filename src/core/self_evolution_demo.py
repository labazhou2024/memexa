...
Usage:
    python -m src.core.self_evolution_demo
...
def run_demo() -> int:
    ...
    with tempfile.TemporaryDirectory(prefix="se_demo_") as td:
        ...
        try:
            from src.core import semantic_kb
        ...
        try:
            import src.core.subagent_feedback_capture as sfc
        ...
        try:
            import src.core.evolution_trigger as et
        ...
        try:
            import src.core.evolution_trigger as et2
        ...
        try:
            import src.core.session_reflector as sr
        ...
        # === P3 helpful credit ===
        try:
            import src.core.pattern_extractor as pe2
