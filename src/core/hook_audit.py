...
Usage:
    python -m src.core.hook_audit list               # table output
    python -m src.core.hook_audit list --json        # JSON for scripts
    python -m src.core.hook_audit list --strict      # exit 1 if any issue
"""
...
def main(argv: Optional[List[str]] = None) -> int:
    p = argparse.ArgumentParser(prog="src.core.hook_audit")
