...
CLI:
    python -m src.core.hard_rule_audit list [--memory-dir PATH]
    python -m src.core.hard_rule_audit verify [--memory-dir PATH]
    python -m src.core.hard_rule_audit drift [--claude-md PATH] [--memory-dir PATH]
...
def main(argv: Optional[List[str]] = None) -> int:
    parser = argparse.ArgumentParser(
        prog="python -m src.core.hard_rule_audit",
    )
