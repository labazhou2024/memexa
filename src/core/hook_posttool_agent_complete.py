...
def _agent_spawns_dir() -> Path:
    ...
    from src.core._agent_spawns import agent_spawns_dir
...
# src.core._safe_fs.is_safe_child (see _safe_fs.py module docstring).

from src.core._safe_fs import is_safe_child as _is_safe_spawn_file  # backwards-compat alias
from src.core._safe_fs import safe_unlink as _safe_unlink_helper
from src.core._safe_fs import safe_unlink_symlink as _safe_unlink_link
...
def main() -> int:
    ...
    try:
        from src.core.agent_stall_detector import post_check
