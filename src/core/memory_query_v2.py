...
from src.core.archive_lookup import lookup_archives_bulk
from src.core.hindsight_client import HindsightHttpClient
from src.core.identity_manifest import ManifestStore, get_default_store
...
def query(
    ...
    *,
    ...
    try:
        from src.core.query_type_classifier import classify
    ...
    if enable_paired_eval and confidence < PAIRED_EVAL_CONFIDENCE_THRESHOLD and reflect_text:
        try:
            from src.core.paired_eval import run_paired_extract  # noqa: F401
