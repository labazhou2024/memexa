...
CLI:
  python -m src.core.plan_uniformity_check <task_id>      # via path resolver
  python -m src.core.plan_uniformity_check --path <plan>  # direct path
  python -m src.core.plan_uniformity_check --self-test    # fixture demo
...
def check_by_task_id(task_id: str, *, strict: bool = True) -> LintResult:
    ...
    from src.core._plan_path_resolver import resolve_plan_path
...
def _cli(argv: List[str]) -> int:
    ...
    if argv[1] == "--self-test":
        from src.core._plan_lint_common import selftest
