...
Usage:
  python -m src.core.ci_env_grep_gate check          # scan + verdict
  python -m src.core.ci_env_grep_gate list           # print current allowlist
  python -m src.core.ci_env_grep_gate add-allowed NAME --ceo-approved [--reason TEXT]
...
def check() -> int:
    ...
    if new:
        ...
        for n in new:
            print(f"  - {n}")
        print(
            f"To add: python -m src.core.ci_env_grep_gate "
