...
CLI:
    python -m src.core.integration_test_matrix validate <plan_path>
    python -m src.core.integration_test_matrix cluster  <plan_path>
    python -m src.core.integration_test_matrix generate <plan_path> --out-dir <dir>
"""
