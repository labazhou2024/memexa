...
# memexa.chat.metadata_builder for back-compat with existing test_chat_extract_local
# imports. New code MUST use the metadata_builder helpers directly.
from memexa.chat.metadata_builder import (  # noqa: E402
...
def paired_extract_for_chat(
    ...
    if use_paired:
        ...
        from memexa.core.paired_eval import (  # noqa: WPS433
            paired_extract,
        ...
        from memexa.extraction.mlx_lm_wrapper import extract_chat_triples  # noqa: WPS433
...
def _build_factrow(
    ...
    `memexa.chat.metadata_builder._build_chat_metadata` (single helper site
    ...
    """
    from memexa.chat.metadata_builder import _build_chat_metadata
    ...
    if pseudonymize:
        ...
        from memexa.extraction.entity_pseudonym import resolve_or_mint_uuid
...
def extract_from_recent_dump(
    ...
    """
    from memexa.extraction.chat_class_denylist import filter_message
    from memexa.extraction.consent_gate import evaluate
    ...
    if mock_llm:
        ...
        from memexa.extraction.mlx_lm_wrapper import extract_chat_triples
