...
CLI
---
  python -m memexa.extraction.mlx_lm_serial_lock status
  python -m memexa.extraction.mlx_lm_serial_lock force-break
"""
...
def _cli(argv: list) -> int:
    """python -m memexa.extraction.mlx_lm_serial_lock {status|force-break}"""
    import sys
