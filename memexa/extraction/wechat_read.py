...
Smoke:
    python -m memexa.memexa.extraction.wechat_read --smoke --date 2026-04-30 --chat Alice
"""
...
from memexa.wechat_db import WeChatDBReader, WxMessage
...
def watch_realtime(
    ...
    import signal
    import time
    from memexa.wechat_db import WeChatDBWatcher
    from memexa.extraction.keystone_outbox import append_message
