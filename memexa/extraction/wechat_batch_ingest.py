...
from memexa.extraction.wechat_batch_cursor import (
    CursorReader,
    CursorWriter,
    chat_hash,
    lookback_clamp,
)
from memexa.extraction.wechat_batch_dedup import DedupOracle, _msg_hash
...
class BatchIngestRunner:
    ...
    def _extract_and_enqueue(self, msgs: list, max_cost_usd: float) -> tuple[int, float]:
        ...
        cmd = [
            _sys.executable, "-m", "memexa.extraction.batch_chat_extract",
...
def main() -> int:
    """CLI entrypoint: `python -m memexa.extraction.wechat_batch_ingest [--dry-run]`."""
    import argparse
