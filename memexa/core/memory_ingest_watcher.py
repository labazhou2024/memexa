...
try:
    from memexa.core.governance_middleware import pre_write_check
...
try:
    from memexa.core.llm_budget import check_and_reserve as _budget_check
    from memexa.core.llm_budget import refund as _budget_refund
    from memexa.core.llm_budget import record_actual as _budget_record_actual
except Exception:  # pragma: no cover
...
def scan_and_ingest(
    ...
    for file_path in sorted(mdir.glob("*.md")):
        ...
        try:
            from memexa.core.canonicalizer import _build_entity_map, _normalize
        ...
        if _pe is not None:
            try:
                from memexa.core.pattern_extractor import PatternEntry, Provenance
