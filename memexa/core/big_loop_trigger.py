...
CLI:
    python -m memexa.core.big_loop_trigger          # invoked by post-commit
    python -m memexa.core.big_loop_trigger --status # show counter, no inc
    python -m memexa.core.big_loop_trigger --reset  # zero counter
"""
...
def _spawn_big_loop() -> dict:
    ...
    try:
        cmd = [sys.executable, "-m", "memexa.core.big_loop"]
