...
from memexa.core._atomic_state import atomic_update_json, atomic_read_json
...
# ----------------------------------------------------------------------------
# TU-2 (autopilot_pi 2026-04-30): in-module CLI for `python -m memexa.core.task_dir_layout`.
...
def _build_arg_parser():
    ...
    p = argparse.ArgumentParser(
        prog="python -m memexa.core.task_dir_layout",
