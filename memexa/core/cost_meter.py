...
CLI:
  python -m memexa.core.cost_meter daily              # text summary
  python -m memexa.core.cost_meter daily --json       # JSON summary
  python -m memexa.core.cost_meter summary <tid>      # per-task summary
  python -m memexa.core.cost_meter summary <tid> --json
"""
...
_USAGE = (
    "Usage:\n"
    "  python -m memexa.core.cost_meter daily [--json]\n"
    "  python -m memexa.core.cost_meter summary <task_id> [--json]\n"
)


def main() -> int:
    """CLI entry: python -m memexa.core.cost_meter <subcmd>"""
    args = sys.argv[1:]
    if not args:
