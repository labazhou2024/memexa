...
CLI:
    python -m memexa.core.schtask_health           # refresh + print cheatsheet
    python -m memexa.core.schtask_health --json    # raw JSON only
    python -m memexa.core.schtask_health --digest  # daily digest (markdown)
"""
