...
API:
  from memexa.core.overrides import get_override
...
CLI:
  python -m memexa.core.overrides list        # show migrated vars + status
  python -m memexa.core.overrides check       # verify no stale references
"""
