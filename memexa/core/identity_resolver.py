...
CLI:
  python -m memexa.core.identity_resolver list                 # list canonical_ids
  python -m memexa.core.identity_resolver show <name>          # full info one entity
  python -m memexa.core.identity_resolver resolve <name>       # → canonical_id(s)
  python -m memexa.core.identity_resolver expand <name>        # → [aliases...]
"""
