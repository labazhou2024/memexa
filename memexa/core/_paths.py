...
Resolution order:
  ...
  3. Defer to :func:`memexa.core._path_resolver.workspace_root` (env / config / default).
"""

import os
from pathlib import Path
from memexa.core._path_resolver import workspace_root as _resolver_workspace_root
...
def find_workspace() -> Path:
    ...
    try:
        here = Path(__file__).parent  # memexa/core/
        candidate = here.parent.parent  # memexa/core -> src -> repo root
