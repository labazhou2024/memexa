...
Workflow:
  ...
  2. CEO runs `python -m memexa.core.ceo_approve <task_id> [--reason "..."]`
...
# Verifier in memexa.core._hook_utils._verify_bench_bypass_token.
...
def _cli(argv: Optional[list] = None) -> int:
    import argparse
    p = argparse.ArgumentParser(prog="memexa.core.ceo_approve")
