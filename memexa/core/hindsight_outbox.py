...
- Background `python -m memexa.core.hindsight_outbox drain` reads pending,
...
def _is_safe_memory_file_at_drain(file_path: str) -> bool:
    ...
    """
    try:
        from memexa.core.memory_write_hook import _is_memory_file
    ...
    with _acquire_pid_lock() as got_pid:
        ...
        for iteration in range(max_iter):
            ...
            if client_obj is None:
                try:
                    from memexa.core.hindsight_client import get_client
...
def _cli(argv: List[str]) -> int:
    ...
    parser = argparse.ArgumentParser(prog="memexa.core.hindsight_outbox")
