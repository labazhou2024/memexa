...
CLI:
    python -m memexa.core.migrate_patterns dry-run
    python -m memexa.core.migrate_patterns apply
"""
...
from memexa.core.pattern_extractor import _PATTERNS_FILE, _DATA_DIR
...
def main(argv: Optional[List[str]] = None) -> int:
    ...
    if not argv or argv[0] in ("-h", "--help"):
        print(
            "Usage: python -m memexa.core.migrate_patterns [dry-run|apply]",
            file=sys.stderr,
        )
        return 2
    cmd = argv[0]
