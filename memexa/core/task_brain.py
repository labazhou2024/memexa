...
callers. Kept for archive/tests only. New code: use memexa.core.memory_query.
            ...
            if t["type"] == "auto_fix_tests":
                ...
                candidates.append({
                    ...
                    "prompt": "Run semantic memory consolidation and report results:\n"
                              "python -c \"import asyncio; from memexa.core.auto_dream import AutoDream; "
        ...
        if self._completed_since_last_loop >= 5:
            ...
            return {
                ...
                "prompt": "Run big loop automated stages:\n"
                          "python -c \"\nimport asyncio\n"
                          "from memexa.core.big_loop import BigLoop\n"
                          "from pathlib import Path\n"
