...
def _credit_helpful_patterns(reason: str) -> dict:
    ...
    try:
        ...
        from memexa.core._hook_utils import get_workspace_paths as _gwp
        data_dir = _gwp()["data"]
        ...
        import memexa.core.pattern_extractor as _pe
...
def _run_autodream() -> dict:
    ...
    try:
        ...
        from memexa.core.auto_trigger import reset_dream_counter
