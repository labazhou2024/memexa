...
Usage:
    ...
    python -m memexa.core.memory_sync_cli drain --limit 50
    python -m memexa.core.memory_sync_cli backfill-missing --limit 30
    python -m memexa.core.memory_sync_cli status
"""
...
def drain(limit: int = 50, timeout: float = 60.0,
    ...
    try:
        from memexa.core.graph_memory import ingest_file
...
def _files_in_graph() -> set:
    ...
    try:
        from memexa.core.graph_memory import _get_driver
    except Exception:
        return set()
    try:
        d = _get_driver()
...
def _cli(argv: Optional[List[str]] = None) -> int:
    ...
    p = argparse.ArgumentParser(prog="memexa.core.memory_sync_cli")
