...
CLI:
  python -m memexa.core.memory_pipeline_diag             # last 100 events
  python -m memexa.core.memory_pipeline_diag --last 500  # custom window
  python -m memexa.core.memory_pipeline_diag --json      # machine-readable
