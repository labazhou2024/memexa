...
def _extract_topics(prompt: str) -> List[str]:
    try:
        from memexa.core.lesson_card_v1 import extract_topics
...
def _query_lessons(topics: List[str], full_prompt: str = "") -> List[Dict[str, Any]]:
    ...
    def _do_query():
        from memexa.core.memory_query import _recall_raw
...
# Standalone test entry: `python -m memexa.core.userprompt_lesson_recall test "your prompt here"`
