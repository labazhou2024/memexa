...
CLI:
  python -m memexa.core.cold_start_meter             # print JSON histogram
  python -m memexa.core.cold_start_meter --baseline  # save snapshot to data/
  python -m memexa.core.cold_start_meter --check     # exit 1 if over limits
"""
