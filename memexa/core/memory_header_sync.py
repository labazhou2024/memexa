...
Usage:
    ...
    python -m memexa.core.memory_header_sync --dry-run   # show diff
    python -m memexa.core.memory_header_sync --apply     # rewrite
"""
...
def _cli(argv: Optional[list] = None) -> int:
    ...
    p = argparse.ArgumentParser(prog="memexa.core.memory_header_sync")
