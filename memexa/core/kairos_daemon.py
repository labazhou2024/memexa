...
Usage:
  python -m memexa.core.kairos_daemon              # Run daemon (async, 2 workers)
  python -m memexa.core.kairos_daemon --duration 60 # Auto-stop after 60min
  python -m memexa.core.kairos_daemon --once        # One project and exit
  python -m memexa.core.kairos_daemon --workers 3   # 3 parallel workers
"""
