...
CLI:
  python -m memexa.core.memory_guardrail status   # current usage + flag state
  python -m memexa.core.memory_guardrail clear    # remove block flag (CEO ack)
  python -m memexa.core.memory_guardrail monitor  # foreground watchdog (debug)

Library:
  from memexa.core.memory_guardrail import MemoryGuardrail
...
def main(argv: Optional[list] = None) -> int:
    ...
    print("usage: python -m memexa.core.memory_guardrail {status|clear|monitor}", file=sys.stderr)
    return 2
