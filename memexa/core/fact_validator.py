...
from memexa.core.entity_resolver import canonicalize as _canonicalize_entity

# Import scrub_pii from the existing keystone outbox helper
try:
    from memexa.extraction.keystone_outbox import scrub_pii
    _HAS_SCRUB = True
except ImportError:
    _HAS_SCRUB = False
...
def run_gates(
    ...
    memexa.core.trace_sink.write_trace_event.
    """
    ...
    from memexa.core.fact_schema import _REQUIRED_FIELDS  # type: ignore[attr-defined]
